$(document).ready(function() {
	...
	$(".sidenav span").on("click", function() {
		switch($(this).data("categ"))
		{
			...
			case 10:	//Movies HD & SD subsectiis
			case 11:
			case 12:
			case 13:
			case 14:
					...
					fields: [
						...
						{ name: "Titlu", title: "Title", type: "text", width: 150,
							itemTemplate: function(value, item) {
								...
								var tooltip = item.Obs != "" ? "title=\"" + item.Obs + "\"" : "aaa";
		...
		if ($(this).data("categ") == 1){

		}
		else{
			if ($(this).hasClass("sidenav-back"))
			{
				DisplayHome();
			}

			if ($(this).hasClass("sidenav-subsection"))
			{
